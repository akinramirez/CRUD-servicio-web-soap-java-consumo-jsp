          ...
          <div class="card">
            ...
            <div class="card-body">
              <form role="form" action="user" method="post">
                ...
                <input type="text" name="txtNombres" class="form-control form-control-sm" autocomplete="off">
                <label>Apellidos</label>
                <input type="text" name="txtApellidos" class="form-control form-control-sm" autocomplete="off">
                <br>
